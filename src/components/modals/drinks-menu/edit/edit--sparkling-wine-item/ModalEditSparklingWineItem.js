...
import classes from "./ModalEditSparklingWineItem.module.scss";
...
const ModalEditSparklingWineItem = (props) => {
    ...
    <div className={classes.page}>
      <form className={classes.form} id="form" onSubmit={onSubmitHandler}>
        ...
        <input
          ...
          type="number"
          defaultValue={modalCtx.itemCentiliter}
...
export default ModalEditSparklingWineItem;
