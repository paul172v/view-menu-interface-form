...
import classes from "./ModalEditStandardDrinksItem.module.scss";
...
const ModalEditStandardDrinksItem = (props) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    const percentageValue = inputtedPercentage.current.value;
    ...
    <div className={classes.page}>
      <form className={classes.form} id="form" onSubmit={onSubmitHandler}>
        ...
        <input
          ...
          ref={inputtedDetails}
        />
        <label className={classes.label} htmlFor="input-percentage">
          Percentage
        </label>
        <input
          className={classes.input}
          ...
          defaultValue={modalCtx.itemPercentage}
          ref={inputtedPercentage}
        />
...
export default ModalEditStandardDrinksItem;
