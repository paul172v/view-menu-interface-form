...
import classes from "./ModalEditStandardItemWithAdds.module.scss";
...
const ModalEditStandardItemWithAdds = () => {
    ...
    <div className={classes.page}>
      <form className={classes.form} id="form" onSubmit={onSubmitHandler}>
        ...
        <input
          ...
          defaultValue={modalCtx.itemAdd1Name}
        ...
        <input
          ...
          type="number"
          step=".01"
          defaultValue={modalCtx.itemAdd1Price}
        ...
        <input
          ...
          type="text"
          name="input-add1-name"
          defaultValue={modalCtx.itemAdd2Name}
        ...
        <input
          ...
          type="number"
          step=".01"
          defaultValue={modalCtx.itemAdd2Price}
...
export default ModalEditStandardItemWithAdds;
